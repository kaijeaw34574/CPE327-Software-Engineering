...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar" style="background: linear-gradient( coral, #0ed2f7);">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">Chaos-Staff</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content" style="background: linear-gradient( #FFF1EE, #FFEEF1);">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        if($_SESSION['type'] == 'Admin')
                        {
                            ...
                            foreach($user_result as $row)
                            {
                                ...
                                $user_profile_image = '../img/doc_earth.jpg';
                            }
                        }
