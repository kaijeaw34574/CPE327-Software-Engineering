					...
					if($appointment_row["patient_come_into_hospital"] == 'Yes')
					{
						if($appointment_row["status"] == 'Completed')
						{
							...
							$html .= '
								<tr>
									...
									<td>
										<textarea name="doctor_price" id="doctor_price" class="form-control" rows="9" required>'.$appointment_row["price"].'</textarea>
									</td>
								</tr
							';
						}
						else
						{
							...
							<tr>
								<th width="40%" class="text-right">Price</th>
								<td>
									<textarea name="doctor_price" id="doctor_price" class="form-control" rows="9" required></textarea>
								</td>
							</tr
						';
						}
